...
from msaFeature.base import signal
from msaFeature.base.signal import switch_unregistered, switch_updated
...
class MSAManager(threading.local):
    ...
    def active(self, name, *inputs, **kwargs):
        ...
        if (
            switch.concent
            and switch.parent
            and not self.active(switch.parent.name, *inputs, **kwargs)
        ):
            return False
